...
## 🏗️ Data Pipeline
Before the chatbot becomes operational, the dormitory data is processed through the following pipeline:

Web Scraping: Automatically extract dormitory data from source websites (e.g., RentHub) to collect details such as names, pricing, amenities, and addresses.

🔗 Google Colab: [Web Scraping Step](https://colab.research.google.com/drive/10suHx7CTBzNjTbUrV6ddgpxyhC9Phvm5?usp=sharing)

Data Prep & Embedding: The scraped data undergoes a cleaning and structuring process. It is then passed through a model to generate Vector Embeddings and stored in a Supabase database to enable efficient Semantic Search.
