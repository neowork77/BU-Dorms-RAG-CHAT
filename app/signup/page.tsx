...
export default function SignupPage() {
  ...
  // Submit handler - register with Supabase
  const handleSubmit = useCallback(
    ...
    [email, password, displayName, supabase, loginSuccessInput, loginFailInput, router]
  );
      ...
      <div className="flex-1 flex flex-col justify-center items-center py-8 lg:py-10 px-4 sm:px-10">
        <div className="w-full max-w-[460px]">
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            {/* <label className="flex items-center gap-3 mt-1 cursor-pointer group ml-1">
              <div className="relative flex items-center justify-center w-[22px] h-[22px] bg-primary rounded-md shrink-0">
